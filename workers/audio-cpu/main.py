...
async def generate_video_background(
    ...
    try:
        ...
        vision_prompt = (
            ...
            f"Include:\n"
            f"1. 'protagonist': A SURREAL or HIGHLY STYLIZED character (e.g., 'a faceless entity made of light', 'a cyber-samurai in a digital void').\n"
            f"2. 'artistic_movement': A bold style (e.g., 'Biomechanical Surrealism', 'Glitch Art Renaissance', 'Noir Cyberpunk').\n"
            f"3. 'color_palette': 3 specific hex codes or complex color names.\n"
            f"4. 'lighting_mood': Atmospheric lighting (e.g., 'bioluminescent fog', 'strobe-lit darkness').\n"
            f"5. 'narrative_arc': An abstract, metaphorical story summary.\n"
